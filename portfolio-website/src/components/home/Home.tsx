...
export default function Home() {
    ...
    //TODO light dark mode context

    useEffect(() => {
        let lightDark = localStorage.getItem('light-mode')
        if (!lightDark) {
            localStorage.setItem('light-mode', 'light')
            lightDark = 'light'
        }
        ...
        const timeout = isLoaded != "true" ? 3000 : 0
        console.log(timeout)
            ...
            >
                ...
                >
                    <div className='col-6'>
                        {
                            (showUI && isSafariBool) ?
                                <SafariAppsUI darkMode={darkMode}></SafariAppsUI>
                                :
